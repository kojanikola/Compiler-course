...
"+++"		{ return new_symbol(sym.PLUSDVA, yytext()); }
...
"@"			{ return new_symbol(sym.ET,yytext()); }
"#"			{ return new_symbol(sym.TARABA, yytext()); }
"cezar"		{ return new_symbol(sym.CEZAR, yytext()); }
"kvadrat"	{ return new_symbol(sym.KVADRAT, yytext()); }
